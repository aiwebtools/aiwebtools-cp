...
const BestAIToolsPage = () => {
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://aiwebtools.ai" },
      { "@type": "ListItem", "position": 2, "name": "Best AI Tools", "item": "https://aiwebtools.ai/best-ai-tools" }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://aiwebtools.ai/best-ai-tools" />
        ...
        <meta property="og:url" content="https://aiwebtools.ai/best-ai-tools" />
