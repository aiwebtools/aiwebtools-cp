...
const BestAIToolsPage = () => {
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://aiwebtools.app" },
      { "@type": "ListItem", "position": 2, "name": "Best AI Tools", "item": "https://aiwebtools.app/best-ai-tools" }
    ]
  };
  ...
  const itemListSchema = {
    ...
    "itemListElement": topTools.slice(0, 30).map((tool, index) => ({
      ...
      "url": `https://aiwebtools.app/${generateToolSlug(tool.title)}`
    }))
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://aiwebtools.app/best-ai-tools" />
        ...
        <meta property="og:url" content="https://aiwebtools.app/best-ai-tools" />
