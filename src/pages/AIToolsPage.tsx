...
const AIToolsPage = () => {
  ...
  const itemListSchema = {
    ...
    "itemListElement": allTools.slice(0, 100).map((tool, index) => ({
      ...
      "url": `https://aiwebtools.app/${tool.title.toLowerCase().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-').substring(0, 50)}`
    }))
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://aiwebtools.app/ai-tools" />
        ...
        <meta property="og:url" content="https://aiwebtools.app/ai-tools" />
