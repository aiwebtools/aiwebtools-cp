...
const AIWebToolsPage = () => {
  ...
  const organizationSchema = {
    ...
    "logo": "https://aiwebtools.ai/lovable-uploads/fe59a436-1f90-45d6-9b98-236a54034010.png",
  ...
  const collectionPageSchema = {
    ...
    "url": "https://aiwebtools.ai/ai-web-tools",
    "mainEntity": {
      "@type": "ItemList",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "AI Web Tools",
        "item": "https://aiwebtools.ai/ai-web-tools"
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://aiwebtools.ai/social-thumbnail.png" />
