          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-gray-800/70 border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white"
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-purple-800/70 border-purple-600 text-purple-300 hover:bg-purple-700 hover:text-white"
              >
                🤖 View All AI Tools
              </Button>
            </div>
