...
export const aiMeetingAssistants: Tool[] = [
  {
    ...
    tags: ["meeting recording", "transcription", "voice analytics", "action items", "team collaboration"],
  ...
  },
  {
    ...
    tags: ["free meeting notes", "no bot", "CRM sync", "highlights", "summaries"],
    category: "AI Meeting Assistants",
    rating: 4.8,
    totalVotes: 8901
  },
  {
    ...
    tags: ["conversation intelligence", "CRM integration", "sales meetings", "customer success", "revenue optimization"],
    category: "AI Meeting Assistants",
    rating: 4.6,
    totalVotes: 5678
  },
  {
    ...
    tags: ["revenue teams", "customer insights", "highlight reels", "sales enablement", "AI summaries"],
    category: "AI Meeting Assistants",
    rating: 4.5,
    totalVotes: 4567
  },
  {
    ...
    tags: ["automated attendance", "comprehensive notes", "multi-meeting insights", "follow-ups", "productivity"],
    category: "AI Meeting Assistants",
    rating: 4.4,
    totalVotes: 3890
  },
  {
    ...
    tags: ["real-time transcription", "privacy focused", "action items", "custom AI prompts", "local processing"],
    category: "AI Meeting Assistants",
    rating: 4.6,
    totalVotes: 6123
  }
