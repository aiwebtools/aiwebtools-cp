...
import { Phone, Users, Gamepad2, Music, Mic } from "lucide-react";

export const communicationAndEntertainmentGPTs: Tool[] = [
  {
    icon: Phone,
  ...
  },
  {
    ...
    tags: ["game design", "game development", "game planning", "development tools", "interactive entertainment", "Custom GPT", "video game", "video game generator", "ai to make video games", "make video games"],
    category: "Communication & Entertainment",
    rating: 4.8,
    totalVotes: 6234
  },
