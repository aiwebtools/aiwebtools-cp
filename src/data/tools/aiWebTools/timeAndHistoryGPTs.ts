...
import { Clock, History, Users, Globe, Book, Compass, Telescope, Crown, MapPin, Calendar } from "lucide-react";
...
export const timeAndHistoryGPTs: Tool[] = [
  {
    ...
    tags: ["time travel", "historical exploration", "future scenarios", "alternative realities", "interactive history"],
  ...
  },
  {
    ...
    tags: ["historical figures", "educational conversations", "historical insights", "learning tool", "interactive history"],
    category: "Education & Learning",
    rating: 4.8,
    totalVotes: 7234
  },
  {
    ...
    tags: ["Titanic history", "historical storytelling", "passenger stories", "maritime history", "survivor testimonies"],
    category: "Education & Learning",
    rating: 4.7,
    totalVotes: 5432
  },
  {
    ...
    tags: ["historical news", "period journalism", "historical context", "news recreation", "historical perspective"],
    category: "Education & Learning",
    rating: 4.6,
    totalVotes: 4567
  },
  {
    ...
    tags: ["Native American history", "cultural exploration", "indigenous wisdom", "historical immersion", "cultural education"],
    category: "Education & Learning",
    rating: 4.8,
    totalVotes: 6234
  }
