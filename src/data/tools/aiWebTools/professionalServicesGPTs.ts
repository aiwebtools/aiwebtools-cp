...
export const professionalServicesGPTs: Tool[] = [
  {
    ...
    tags: ["automotive expert", "car advice", "vehicle maintenance", "dealership guidance", "auto repair", "aiwebtools"],
  ...
  },
  {
    ...
    tags: ["home renovation", "DIY projects", "cost estimation", "contractor finding", "home improvement", "aiwebtools"],
    category: "Professional Services",
    rating: 4.7,
    totalVotes: 5432
  },
  {
    ...
    tags: ["fishing guidance", "fishing spots", "fishing gear", "fishing regulations", "fishing assistant", "aiwebtools"],
    category: "Professional Services",
    rating: 4.6,
    totalVotes: 4321
  },
  {
    ...
    tags: ["farming", "agriculture", "crop management", "agricultural expert", "farming assistance", "aiwebtools"],
    category: "Professional Services",
    rating: 4.5,
    totalVotes: 3876
  },
  {
    ...
    tags: ["property data", "real estate", "property information", "market value", "property analysis", "aiwebtools"],
    category: "Professional Services",
    rating: 4.7,
    totalVotes: 5234
  }
