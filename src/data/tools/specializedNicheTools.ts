...
export const specializedNicheTools: Tool[] = [
  {
    icon: Leaf,
    title: "AICannabisTools",
    description: "Comprehensive suite of 100% free AI tools dedicated to the cannabis industry. Tools cover wide range of applications, from horticulture to compliance, cooking, medical cannabis, and more.",
    emoji: "🌿",
