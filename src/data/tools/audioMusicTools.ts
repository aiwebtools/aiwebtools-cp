...
export const audioMusicTools: Tool[] = [
  {
    ...
    tags: ["music generation", "AI music", "composition", "songs", "audio creation", "text to music"],
  ...
  },
  {
    ...
    tags: ["music generation", "audio", "composition", "AI music", "songs", "instrumentals"],
    category: "Audio & Music Production"
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    tags: ["text to speech", "voice synthesis", "audio", "sound effects", "voiceover", "TTS", "voice cloning"],
    category: "Audio & Music Production"
  },
  {
    icon: BookOpen,
    ...
    tags: ["podcast", "script writing", "audio storytelling", "episode outlines", "content creation"],
    category: "Audio & Music Production"
  }
];
