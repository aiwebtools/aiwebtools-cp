...
export const nameInsightTool: Tool = {
  ...
  tags: ["name analysis", "personality insights", "numerology", "cultural significance", "personal discovery", "identity", "name meaning", "name research"],
  emoji: "🏷️",
