...
export const videoTools: Tool[] = [
  {
    ...
    tags: ["video analysis", "frame analysis", "media", "content", "breakdown"],
  ...
  },
  {
    ...
    tags: ["video creation", "AI video", "editing", "content", "text to video"],
    category: "Video Tools"
  },
  {
    icon: BookOpen,
    ...
    tags: ["video generation", "AI video", "editing", "effects", "creation"],
    category: "Video Tools"
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    tags: ["video generation", "AI video", "professional", "content", "chinese ai"],
    category: "Video Tools"
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    tags: ["video generation", "sound effects", "Google", "multimedia", "veo"],
    category: "Video Tools"
  },
  {
    icon: BookOpen,
    ...
    tags: ["video generation", "music generation", "multimedia", "AI creation", "chinese"],
  ...
  },
  {
    ...
    tags: ["video generation", "AI video", "creative", "animation", "pika"],
    category: "Video Tools"
  },
  {
    icon: BookOpen,
