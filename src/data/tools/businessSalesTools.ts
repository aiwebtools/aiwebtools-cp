...
export const businessSalesTools: Tool[] = [
  {
    ...
    tags: ["CRM", "sales automation", "marketing", "customer service", "workflows"],
  ...
  },
  {
    ...
    directUrl: "https://www.pipedrive.com/",
    tags: ["sales CRM", "pipeline management", "SMB", "AI insights", "automation"],
    category: "Business & Sales Tools",
    rating: 4.5,
    totalVotes: 3456
  },
  {
    ...
    tags: ["customer messaging", "AI chatbots", "support automation", "customer engagement", "lifecycle"],
    category: "Business & Sales Tools",
    rating: 4.4,
    totalVotes: 3234
  },
  {
    ...
    directUrl: "https://www.gong.io/",
    tags: ["revenue intelligence", "sales conversations", "AI insights", "deal outcomes", "team performance"],
    category: "Business & Sales Tools",
    rating: 4.6,
    totalVotes: 2987
  },
  {
    ...
    directUrl: "https://www.outreach.io/",
    tags: ["sales engagement", "prospect engagement", "sequence optimization", "AI-powered", "efficiency"],
    category: "Business & Sales Tools",
    rating: 4.3,
    totalVotes: 2654
  },
  {
    ...
    tags: ["automated scheduling", "meeting scheduling", "workflow automation", "integrations", "efficiency"],
    category: "Business & Sales Tools",
    rating: 4.5,
    totalVotes: 3789
  },
  {
    ...
    directUrl: "https://www.zoominfo.com/",
    tags: ["B2B database", "sales intelligence", "prospect finding", "contact data", "company data"],
    category: "Business & Sales Tools",
    rating: 4.4,
    totalVotes: 2876
  },
  {
    icon: DollarSign,
    title: "Stripe",
    description: "Payment processing platform with AI-powered fraud detection and financial tools. Accept payments online and manage revenue operations.",
    emoji: "💳",
    color: "from-purple-500 to-indigo-600",
    directUrl: "https://stripe.com/",
    tags: ["payment processing", "fraud detection", "online payments", "revenue operations", "financial tools"],
    category: "Business & Sales Tools",
    rating: 4.8,
    totalVotes: 4321
  },
  {
    ...
    tags: ["work OS", "project management", "CRM", "team collaboration", "workflow automation"],
    category: "Business & Sales Tools",
    rating: 4.3,
    totalVotes: 3456
  }
