...
export const specializedAndNiche: Tool[] = [
  ...
  },
  {
    ...
    description: "Professional culinary guidance for chefs, home cooks, and food enthusiasts with recipes, techniques, and kitchen management.",
    emoji: "👨‍🍳",
    color: "from-orange-500 to-red-600",
    directUrl: "https://chefgpt.lovable.app/?via=aiwebtools",
    videoUrl: "https://www.youtube.com/watch?v=vJz1HOGtV0I",
    category: "Specialized & Niche",
    tags: ["cooking", "culinary", "recipes", "chef"],
    rating: 4.5,
    totalVotes: 2143
  },
  {
    ...
    description: "Analyze names for meanings, origins, personality insights, and cultural significance with comprehensive name research capabilities.",
    emoji: "📛",
    ...
    category: "Specialized & Niche",
    tags: ["names", "research", "meaning", "cultural analysis"],
    rating: 4.3,
    totalVotes: 1654
  },
  {
    ...
    description: "Explore Native American history, culture, and traditions through immersive historical experiences and educational content.",
    emoji: "🏹",
    ...
    category: "Specialized & Niche",
    tags: ["Native American", "history", "culture", "education"],
    rating: 4.6,
    totalVotes: 2234
  },
  {
    ...
    description: "Comprehensive cybersecurity guidance for infrastructure protection, threat analysis, and security best practices for IT professionals.",
    emoji: "🛡️",
    ...
    category: "Specialized & Niche",
    tags: ["cybersecurity", "IT security", "threat protection", "infrastructure"],
    rating: 4.7,
    totalVotes: 2987
  },
  {
    icon: TreePine,
    title: "Fungus GPT – AI Mushroom Specialist",
    description: "Expert mushroom identification, cultivation guidance, and mycological knowledge for foragers, researchers, and mushroom enthusiasts.",
    emoji: "🍄",
    color: "from-green-600 to-brown-600",
    directUrl: "https://fungusgpt.lovable.app/?via=aiwebtools",
    imageUrl: "https://img1.wsimg.com/isteam/ip/9fd6d942-5b46-4025-92e2-0f1ec2a7adf2/a-photo-of-a-man-with-a-beard-holding-a-_9DLLj.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:600,cg:true/qt=q:30",
    category: "Specialized & Niche",
    tags: ["mushrooms", "mycology", "foraging", "cultivation"],
    rating: 4.4,
    totalVotes: 1876
  },
  {
    icon: Shovel,
    title: "Drill Baby Drill AI Suite For Oil & Gas",
    description: "Specialized oil and gas industry tools for drilling operations, exploration, and energy sector analysis and planning.",
    emoji: "⛽",
    color: "from-gray-600 to-yellow-600",
    directUrl: "https://drillbabydrillaisuite.lovable.app/?via=aiwebtools",
    imageUrl: "https://img1.wsimg.com/isteam/ip/9fd6d942-5b46-4025-92e2-0f1ec2a7adf2/a-cartoon-illustration-of-a-man-with-a-h_lmQ_X.png/:/cr=t:5.43%25,l:0%25,w:100%25,h:89.13%25/rs=w:600,h:300,cg:true/qt=q:30",
    category: "Specialized & Niche",
    tags: ["oil", "gas", "drilling", "energy sector"],
    rating: 4.2,
    totalVotes: 1543
  },
  {
    ...
    description: "Analyze and interpret dreams with psychological insights, symbolism explanation, and personal meaning exploration.",
    emoji: "💭",
  ...
  },
  {
    ...
    description: "Create engaging podcast scripts, show notes, and episode structures for podcasters and content creators.",
    emoji: "🎙️",
    color: "from-purple-500 to-pink-600",
    ...
    category: "Specialized & Niche",
    tags: ["podcast", "script writing", "content creation", "audio"],
    rating: 4.5,
    totalVotes: 2087
  },
  {
    ...
    description: "Analyze and strategize Universal Basic Income policies, economic impacts, and implementation frameworks for policymakers.",
    emoji: "💰",
    ...
    category: "Specialized & Niche",
    tags: ["UBI", "economic policy", "social welfare", "strategy"],
    rating: 4.4,
    totalVotes: 1654
  },
  {
    ...
    description: "Explore hypothetical scenarios of AI governance and societal impact through interactive simulations and thought experiments.",
    emoji: "🤖",
    color: "from-blue-600 to-purple-600",
    directUrl: "https://ifairuledtheworldgpt.lovable.app/?via=aiwebtools",
    videoUrl: "https://www.youtube.com/watch?v=93M9ZyhpmFM",
    category: "Specialized & Niche",
    tags: ["AI simulation", "futurism", "society", "governance"],
    rating: 4.6,
    totalVotes: 2345
  },
  {
    ...
    description: "Develop strategies and frameworks for international peace-building, conflict resolution, and global cooperation initiatives.",
    emoji: "🕊️",
    ...
    category: "Specialized & Niche",
    tags: ["peace building", "conflict resolution", "global cooperation", "diplomacy"],
    rating: 4.7,
    totalVotes: 2876
  },
  {
    ...
    description: "Professional artwork and vintage item appraisal with market analysis, authenticity assessment, and valuation services.",
    emoji: "🎨",
    ...
    category: "Specialized & Niche",
    tags: ["art appraisal", "vintage items", "valuation", "antiques"],
    rating: 4.5,
    totalVotes: 1987
  },
  {
    ...
    description: "Analyze historical data to discover hidden patterns, connections, and insights across different time periods and cultures.",
    emoji: "🔍",
    ...
    category: "Specialized & Niche",
    tags: ["historical analysis", "pattern recognition", "research", "data analysis"],
    rating: 4.4,
    totalVotes: 1765
  }
];
