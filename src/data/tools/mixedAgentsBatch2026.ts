...
export const mixedAgentsBatch2026: Tool[] = [
  ...
  { icon: Users, title: "Camel-AI", description: "Open-source multi-agent framework for studying agent societies, role-playing collaboration, and large-scale agent communication. Research-grade and production-ready.", emoji: "🐫", color: "from-yellow-600 to-orange-800", directUrl: "https://www.camel-ai.org/?via=aiwebtools", imageUrl: camelAiHero, tags: ["AI Agents", "Multi-Agent Framework", "Open Source", "Agent Societies", "Role-Playing", "Research"], category: "AI Agents", rating: 4.6, totalVotes: 1620 },
