...
export const businessTools: Tool[] = [
  {
    ...
    tags: ["financial planning", "calculations", "investments", "business finance", "market analysis"],
  ...
  },
  {
    ...
    tags: ["market research", "competitive analysis", "business intelligence", "strategic planning"],
    category: "Business Tools",
    rating: 4.8,
    totalVotes: 4123
  },
  {
    ...
    tags: ["team management", "collaboration", "project management", "productivity", "workflow"],
    category: "Business Tools",
    rating: 4.6,
    totalVotes: 3789
  },
