...
export const allTools: Tool[] = [
  ...
  },
  {
    ...
    description: "Interactive celebrity conversations and entertainment chatline experience",
    emoji: "🌟",
    ...
    tags: ["celebrity", "chat", "entertainment", "conversation", "interactive", "fun"],
    category: "Entertainment & Gaming"
  },
  {
    icon: Database,
    title: "ANYTHING LLM",
    description: "Versatile language model platform for unlimited AI conversations and tasks",
    emoji: "💾",
    color: "from-blue-600 to-purple-700",
    videoUrl: "https://www.youtube.com/embed/gd4xkmzLWSQ",
    directUrl: "https://anythingllm.com/",
    tags: ["LLM", "language model", "AI", "versatile", "platform", "unlimited"],
    category: "AI Assistants & Chatbots"
  },
  {
    icon: Flame,
    ...
    emoji: "🚒",
    color: "from-red-600 to-yellow-500",
    videoUrl: "https://www.youtube.com/embed/lGsefWkYfq0",
  ...
  },
  {
    ...
    description: "Advanced binary, text, and image conversion tool for data transformation",
    emoji: "💻",
    color: "from-green-600 to-blue-700",
    ...
    tags: ["binary", "text", "image", "converter", "data", "transformation"],
    category: "Technology & Development"
  },
  {
    icon: Presentation,
    title: "Gamma Presentation & Website Maker",
    description: "AI-powered presentation and website creation platform with professional templates",
    emoji: "📊",
    color: "from-purple-600 to-pink-700",
    videoUrl: "https://www.youtube.com/embed/sy9ZIQlzk3Q",
    directUrl: "https://try.gamma.app/aiwebtools",
    tags: ["presentation", "website", "maker", "templates", "professional", "design"],
    category: "Business & Productivity"
  },
  {
    icon: Video,
    title: "Luma Dream Machine Prompt Assistant",
    description: "Optimized prompt creation for Luma Dream Machine and AI video generation",
    emoji: "🎬",
    color: "from-blue-600 to-purple-700",
    ...
    directUrl: "https://texttovideoprompter.lovable.app/?via=aiwebtools",
    tags: ["Luma", "Dream Machine", "prompts", "video generation", "AI", "optimization"],
    category: "Video Generation & Editing"
  },
  {
    icon: Utensils,
    title: "Restaurant Menu Maker GPT",
    description: "Professional restaurant menu design and food service planning assistant",
    emoji: "🍽️",
    color: "from-orange-600 to-red-700",
    ...
    tags: ["restaurant", "menu", "design", "food", "service", "planning"],
    category: "Business & Productivity"
  },
  {
    icon: FileText,
    title: "Quiz Maker AI",
    description: "Interactive quiz creation and educational assessment tool for learning",
    emoji: "📝",
    color: "from-green-600 to-blue-700",
    ...
    tags: ["quiz", "maker", "education", "assessment", "learning", "interactive"],
    category: "Education & Learning"
  },
  {
    icon: BookOpen,
    title: "Course Maker GPT",
    description: "Comprehensive course creation and curriculum development assistant",
    emoji: "📚",
    color: "from-blue-600 to-green-700",
    ...
    tags: ["course", "maker", "curriculum", "development", "education", "comprehensive"],
    category: "Education & Learning"
  },
  {
    icon: Calculator,
    ...
    emoji: "💰",
    color: "from-green-500 to-blue-600",
    videoUrl: "https://www.youtube.com/embed/xkcsSVbBhf4",
  ...
  },
  {
    icon: Dna,
    title: "Genome GPT",
    description: "Genetic analysis and genomic research assistant for DNA and heredity studies",
    emoji: "🧬",
    color: "from-purple-600 to-blue-700",
    ...
    tags: ["genome", "genetics", "DNA", "heredity", "research", "analysis"],
    category: "Science & Research"
  },
  {
    icon: Gamepad2,
    title: "Game Design Document / Developer GPT",
    description: "Professional game development and design document creation assistant",
    emoji: "🎮",
    color: "from-purple-600 to-blue-700",
    ...
    tags: ["game design", "development", "documents", "professional", "gaming", "creation"],
    category: "Entertainment & Gaming"
  },
  {
    icon: Eye,
    title: "ENTER THE MATRIX GPT (NEO👁️MATRIX GPT)",
    description: "Matrix-inspired AI assistant for digital reality exploration and cyberpunk guidance",
    emoji: "👁️",
    color: "from-green-600 to-black",
    videoUrl: "https://www.youtube.com/embed/BkPCpeu_nSs",
    directUrl: "https://neomatrixgpt.lovable.app/?via=aiwebtools",
    tags: ["Matrix", "Neo", "cyberpunk", "digital", "reality", "exploration"],
    category: "Entertainment & Gaming"
  },
  {
    icon: CreditCard,
    title: "Predictive Credit Score Checker GPT",
    description: "Credit score analysis and financial health prediction assistant",
    emoji: "💳",
    color: "from-blue-600 to-green-700",
    ...
    tags: ["credit score", "financial", "prediction", "analysis", "health", "checker"],
    category: "Legal & Finance"
  },
  {
    icon: UserSearch,
    title: "Name Insight Research & Predictor GPT",
    description: "Name analysis, meaning research, and personality prediction assistant",
    emoji: "🔍",
    color: "from-purple-600 to-blue-700",
    ...
    tags: ["name", "insight", "research", "prediction", "personality", "analysis"],
    category: "Tools & Utilities"
  },
  {
    icon: Palette,
    title: "Coloring Book Generator GPT",
    description: "Creative coloring book and page generation for art and relaxation",
    emoji: "🎨",
    color: "from-pink-600 to-purple-700",
    ...
    tags: ["coloring", "book", "generator", "art", "relaxation", "creative"],
    category: "Creative & Design"
  },
  {
    icon: Video,
    title: "PIKA LABS",
    description: "Advanced AI video generation and editing platform for content creators",
    emoji: "🎬",
    color: "from-purple-600 to-pink-700",
    ...
    directUrl: "http://www.Pika.art",
    tags: ["video generation", "AI", "editing", "content", "creators", "platform"],
    category: "Video Generation & Editing"
  },
  {
    icon: History,
    title: "Native American History Time Machine GPT - (Special Edition)",
    description: "Interactive Native American historical exploration and cultural education",
    emoji: "🪶",
    color: "from-brown-600 to-orange-700",
    videoUrl: "https://www.youtube.com/embed/jVFTGCeuNSM",
    directUrl: "https://nativeamerican-timemachine.lovable.app/?via=aiwebtools",
    tags: ["Native American", "history", "time machine", "cultural", "education", "interactive"],
    category: "Education & Learning"
  },
  {
    icon: Megaphone,
    title: "Public Testimony Writer GPT",
    description: "Professional public testimony and speech writing assistance",
    emoji: "📢",
    color: "from-blue-600 to-gray-700",
    videoUrl: "https://www.youtube.com/embed/-q1oyZZFcI4",
    directUrl: "https://publictestimonywriter.lovable.app/?via=aiwebtools",
    tags: ["public", "testimony", "writing", "speech", "professional", "assistance"],
    category: "Communication & Social"
  },
  {
    icon: Settings,
    title: "MAKE - AUTOMATIONS PLATFORM",
    description: "Advanced automation platform for workflow optimization and business processes",
    emoji: "⚙️",
    color: "from-blue-600 to-purple-700",
    ...
    tags: ["automation", "workflow", "platform", "business", "processes", "optimization"],
    category: "Business & Productivity"
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: "AI-powered website generation platform for professional web development",
    emoji: "🌐",
    color: "from-blue-600 to-green-700",
    ...
    tags: ["website", "generator", "AI", "web development", "professional", "platform"],
    category: "Technology & Development"
  },
  {
    icon: Rocket,
    title: "🚀 Startup Validator GPT",
    description: "Startup idea validation and business concept analysis assistant",
    emoji: "🚀",
    color: "from-purple-600 to-blue-700",
    ...
    tags: ["startup", "validator", "business", "concept", "analysis", "validation"],
    category: "Business & Productivity"
  },
  {
    icon: Monitor,
    title: "PINOKIO.COMPUTER",
    description: "Advanced computer vision and AI development platform",
    emoji: "🖥️",
    color: "from-blue-600 to-purple-700",
    ...
    tags: ["computer vision", "AI", "development", "platform", "advanced", "technology"],
    category: "Technology & Development"
  },
  {
    icon: Video,
    title: "RUNWAY ML",
    description: "Professional AI video generation and creative content platform",
    emoji: "🎬",
    color: "from-purple-600 to-pink-700",
    ...
    tags: ["AI", "video generation", "creative", "content", "platform", "professional"],
    category: "Video Generation & Editing"
  },
  {
    icon: Users,
    title: "Synthesia Avatar Creation Studio",
    description: "AI avatar creation and video synthesis platform for digital content",
    emoji: "👤",
    color: "from-blue-600 to-purple-700",
    ...
    tags: ["avatar", "creation", "video", "synthesis", "AI", "digital content"],
    category: "Video Generation & Editing"
  }
];
