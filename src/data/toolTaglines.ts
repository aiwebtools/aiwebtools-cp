...
export const toolTaglines: Record<string, string> = {
  ...
  "GOD IS LIGHT — Jewish Version GPT": "Torah and Kabbalah reveal the Divine Light. Ein Sof illuminates all.",
  "GOD IS LIGHT — Islamic Version GPT": "Nūr—the Light of Allah illuminates the heavens and the earth.",
  "ALL IS ONE GPT": "Science, spirit, and psychology unite. Discover universal interconnectedness.",
  "Dead Sea Scrolls GPT": "Ancient Qumran manuscripts decoded. Second Temple secrets revealed.",
