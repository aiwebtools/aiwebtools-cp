...
export const getCategoryStyle = (category: string) => {
  const categoryStyles: Record<string, { emoji: string; colors: { bg: string; border: string; hover: string; selected: string } }> = {
    "Writing & Content": {
      ...
      colors: {
        ...
        hover: "hover:bg-blue-500/40 hover:border-blue-400/80",
    ...
    "Image & Design": {
      ...
      colors: {
        ...
        hover: "hover:bg-purple-500/40 hover:border-purple-400/80",
    ...
    "Video Tools": {
      ...
      colors: {
        ...
        hover: "hover:bg-red-500/40 hover:border-red-400/80",
    ...
    "Audio & Music": {
      ...
      colors: {
        ...
        hover: "hover:bg-green-500/40 hover:border-green-400/80",
    ...
    "Business & Productivity": {
      ...
      colors: {
        ...
        hover: "hover:bg-orange-500/40 hover:border-orange-400/80",
    ...
    "Education & Learning": {
      ...
      colors: {
        ...
        hover: "hover:bg-indigo-500/40 hover:border-indigo-400/80",
    ...
    "AI Development Tools": {
      ...
      colors: {
        ...
        hover: "hover:bg-teal-500/40 hover:border-teal-400/80",
    ...
    "AI Chat Platforms": {
      ...
      colors: {
        ...
        hover: "hover:bg-pink-500/40 hover:border-pink-400/80",
    ...
    "Healthcare Professionals": {
      ...
      colors: {
        ...
        hover: "hover:bg-emerald-500/40 hover:border-emerald-400/80",
    ...
    "Legal Professionals": {
      ...
      colors: {
        ...
        hover: "hover:bg-amber-500/40 hover:border-amber-400/80",
    ...
    "Creative & Entertainment": {
      ...
      colors: {
        ...
        hover: "hover:bg-rose-500/40 hover:border-rose-400/80",
    ...
    "Research & Learning": {
      ...
      colors: {
        ...
        hover: "hover:bg-violet-500/40 hover:border-violet-400/80",
    ...
    "AI Agents": {
      ...
      colors: {
        ...
        hover: "hover:bg-slate-500/40 hover:border-slate-400/80",
    ...
    "Game Design & Development": {
      ...
      colors: {
        ...
        hover: "hover:bg-lime-500/40 hover:border-lime-400/80",
    ...
    "Time & History": {
      ...
      colors: {
        ...
        hover: "hover:bg-yellow-500/40 hover:border-yellow-400/80",
    ...
    "AI Art": {
      emoji: "🖼️",
      colors: {
        bg: "bg-fuchsia-800/70",
        border: "border-fuchsia-400/60",
        hover: "hover:bg-fuchsia-500/40 hover:border-fuchsia-400/80",
    ...
    "AI Assistants": {
      ...
      colors: {
        ...
        hover: "hover:bg-cyan-500/40 hover:border-cyan-400/80",
    ...
    "AI Development": {
      ...
      colors: {
        ...
        hover: "hover:bg-sky-500/40 hover:border-sky-400/80",
    ...
    "AI Infrastructure": {
      ...
      colors: {
        ...
        hover: "hover:bg-stone-500/40 hover:border-stone-400/80",
    ...
    "AI Inference Platforms": {
      ...
      colors: {
        ...
        hover: "hover:bg-zinc-500/40 hover:border-zinc-400/80",
    ...
    "AI Productivity Tools": {
      ...
      colors: {
        ...
        hover: "hover:bg-yellow-500/40 hover:border-yellow-300/80",
    ...
    "AI Tools": {
      ...
      colors: {
        ...
        hover: "hover:bg-neutral-500/40 hover:border-neutral-400/80",
    ...
    "AI Tools & Development": {
      ...
      colors: {
        ...
        hover: "hover:bg-red-500/40 hover:border-red-300/80",
    ...
    "AI Tools & Utilities": {
      ...
      colors: {
        ...
        hover: "hover:bg-orange-500/40 hover:border-orange-300/80",
    ...
    "Art & Design": {
      ...
      colors: {
        ...
        hover: "hover:bg-purple-500/40 hover:border-purple-300/80",
    ...
    "Advanced AI Tools": {
      ...
      colors: {
        ...
        hover: "hover:bg-blue-500/40 hover:border-blue-300/80",
  ...
  const defaultStyle = {
    ...
    colors: {
      ...
      hover: "hover:bg-gray-500/40 hover:border-gray-400/80",
