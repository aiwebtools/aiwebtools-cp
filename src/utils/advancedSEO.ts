...
export const generateArticleStructuredData = (tool: any, toolIndex: number) => {
  return {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://aiwebtools.app/tool/${toolIndex}`
    },
...
export const generateVideoObjectStructuredData = (tool: any) => {
  return {
    ...
    "thumbnailUrl": "https://aiwebtools.app/placeholder.svg",
    "uploadDate": "2024-01-01",
    "duration": "PT3M",
    "embedUrl": `https://aiwebtools.app/tool/${tool.title}#video`,
    "publisher": {
      "@type": "Organization",
      "name": "AI WEB TOOLS",
      "logo": {
...
export const generateAdvancedMetaTags = (tool: any, toolIndex: number) => {
  return {
    ...
    "al:web:url": `https://aiwebtools.app/tool/${toolIndex}`,
    ...
    "pinterest:url": `https://aiwebtools.app/tool/${toolIndex}`,
    ...
    "og:see_also": "https://aiwebtools.app",
