...
// Minimal text-only React fallback for Suspense / lazy route transitions.
// No 3D cube — keeps route handoff lightweight so the initial HTML loader
// doesn't compete with an extra animated layer.
const PageLoader = () => {
  return (
