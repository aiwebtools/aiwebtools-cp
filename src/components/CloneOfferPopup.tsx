...
const CloneOfferPopup = () => {
  ...
  const handleClone = (e: React.MouseEvent) => {
    e.preventDefault();
    const cloneUrl = "https://lovable.dev/projects/7522f084-65ae-43db-ab5c-39a09e1882f9?via=aiwebtools";
      ...
      <DialogContent className="sm:max-w-2xl max-w-[95vw] bg-gray-900 border-2 border-cyan-500/50 max-h-[90vh] overflow-y-auto z-[9999] shadow-2xl shadow-cyan-500/20">
        ...
        <div className="w-full aspect-video rounded-lg overflow-hidden mb-4 bg-black border border-gray-700">
          <iframe
            ...
            src={isOpen ? (
              showCount === 3 
                ? "https://www.youtube.com/embed/s5lZHJU3y08?autoplay=1&mute=1&controls=1&rel=0&modestbranding=1&playsinline=1&fs=1&vq=hd1080&hd=1&quality=hd1080&enablejsapi=1"
                : showCount === 2 
                  ? "https://www.youtube.com/embed/nG4NqPwNHaw?autoplay=1&mute=1&controls=1&rel=0&modestbranding=1&playsinline=1&fs=1&vq=hd1080&hd=1&quality=hd1080&enablejsapi=1"
                  : "https://www.youtube.com/embed/lPZVKMfUcrs?autoplay=1&mute=1&controls=1&rel=0&modestbranding=1&playsinline=1&fs=1&vq=hd1080&hd=1&quality=hd1080&enablejsapi=1"
            ) : ""}
