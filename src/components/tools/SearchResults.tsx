...
const SearchResults = memo(({
  ...
  return (
    <div 
      className="absolute top-full left-0 right-0 mt-2 bg-background border border-border rounded-xl shadow-2xl z-[9999] max-h-[70vh] min-h-96 overflow-hidden"
      style={{
    ...
    >
      ...
      >
        <div className="px-3 py-3 border-b border-border/50 sticky top-0 bg-background text-muted-foreground z-10" 
             style={{ 
               fontSize: '10px',
               transform: 'translateZ(0)',
