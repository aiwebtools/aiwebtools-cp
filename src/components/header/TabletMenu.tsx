            ...
            <div className="p-4">
              ...
              <div ref={searchRef} className="relative mb-4">
                ...
                {isSearchOpen && searchResults.length > 0 && (
                  <Card className="absolute top-full left-0 right-0 mt-2 bg-gray-900/95 border border-cyan-500/30 shadow-2xl z-50 max-h-[45vh] overflow-y-auto scrollbar-thin scrollbar-thumb-cyan-500/50 scrollbar-track-gray-800" onScroll={handleScroll}>
              ...
              <div className="space-y-1">
                ...
                <DropdownMenuItem onClick={(e) => { e.preventDefault(); createTimePortalEffect('https://cloneaiwebtools.lovable.app/?via=aiwebtools'); }} className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-black hover:from-yellow-500 hover:to-yellow-700 font-bold rounded my-2 gold-glow">
