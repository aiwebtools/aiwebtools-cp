...
const Logo = () => {
  ...
  return (
    <div className="flex items-center gap-4 flex-shrink-0 relative z-[110]">
      <div className="text-left flex-1">
        <div className="flex items-center gap-2 mb-1">
          <div className="text-xl font-bold bg-gradient-to-r from-cyan-400 via-cyan-300 to-cyan-500 bg-clip-text text-transparent animate-pulse tracking-wider letter-spacing-wide relative">
            <span className="relative z-10 cyber-glow">AITOOLS.STUDIO</span>
            <div className="absolute inset-0 text-xl font-bold text-cyan-400 blur-sm opacity-60 animate-ping"></div>
          </div>
