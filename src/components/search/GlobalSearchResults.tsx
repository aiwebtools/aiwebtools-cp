...
const GlobalSearchResults = ({
  ...
  return (
    <div className="relative">
      <Card 
        ref={scrollRef}
        className="absolute top-full left-0 right-0 mt-2 bg-black border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 z-[90] max-h-[70vh] min-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-cyan-500/50 scrollbar-track-gray-800" 
        onScroll={onScroll}
        style={{
