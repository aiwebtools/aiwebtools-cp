...
const images = [
  ...
  { src: "/images/inspiration/two-angelic-races.jpg", alt: "The Two Angelic Races - Angels of the Kingdom of Light vs Fallen Angels of the Black Hole of Fire" },
  { src: "/images/inspiration/metaphysical-beings-2.jpg", alt: "We are metaphysical beings in a physical world - Distracted by material possessions when we contain the Universe and the Light of God" },
  { src: "/images/inspiration/perspective-2.jpg", alt: "You're the only guy that could look into hell and still smile after - Everything is perspective" },
  { src: "/images/inspiration/light-scrabble-2.jpg", alt: "Quran and Bible both speak of Light - Humans argue over letters while both books speak of the same Light" },
