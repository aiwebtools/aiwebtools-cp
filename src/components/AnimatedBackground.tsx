...
const AnimatedBackground = () => {
  ...
  useEffect(() => {
    ...
    const createStars = () => {
      ...
      for (let i = 0; i < 50; i++) { // Reduced from 200 to 50 for performance
    ...
    const createParticles = () => {
      ...
      for (let i = 0; i < 8; i++) { // Reduced from 20 to 8 for performance
    ...
    const createShootingStars = () => {
      ...
      for (let i = 0; i < 3; i++) { // Reduced from 10 to 3 for performance
    ...
    const createMatrixCode = () => {
      ...
      const columns = Math.min(Math.floor(window.innerWidth / columnWidth), isMobile ? 10 : 20); // Further reduced columns
