...
const BookPromotionCard = () => {
  ...
  const originalVideos = [
    ...
    { id: "I6kOI_q0aHE", title: "MTV Lineup — New Drop 01", gradient: "from-fuchsia-500/20 to-cyan-500/20" },
    { id: "ZIr6c-fY9fs", title: "MTV Lineup — New Drop 02", gradient: "from-emerald-500/20 to-cyan-500/20" },
    { id: "uGkb2zOYKSk", title: "MTV Lineup — New Drop 03", gradient: "from-purple-500/20 to-fuchsia-500/20" },
    { id: "CCNMLCJr41c", title: "MTV Lineup — New Drop 04", gradient: "from-rose-500/20 to-pink-500/20" },
    { id: "0YLdn4k5TCE", title: "MTV Lineup — New Drop 05", gradient: "from-amber-500/20 to-orange-500/20" },
    { id: "0oHdDEbPMyo", title: "MTV Lineup — New Drop 06", gradient: "from-cyan-500/20 to-teal-500/20" },
    { id: "1RQx5iQNiNQ", title: "MTV Lineup — New Drop 07", gradient: "from-indigo-500/20 to-purple-500/20" },
    { id: "6OlRbGLY_Z8", title: "MTV Lineup — New Drop 08", gradient: "from-emerald-500/20 to-lime-500/20" },
    { id: "J1dqyotA-X4", title: "MTV Lineup — New Drop 09", gradient: "from-sky-500/20 to-cyan-500/20" },
    { id: "ZjLyv3kHtOU", title: "MTV Lineup — New Drop 10", gradient: "from-violet-500/20 to-fuchsia-500/20" },
    { id: "vnIOMTuA7Ys", title: "MTV Lineup — New Drop 11", gradient: "from-orange-500/20 to-red-500/20" },
    { id: "j1UWJuVAaZg", title: "MTV Lineup — New Drop 12", gradient: "from-purple-500/20 to-indigo-500/20" },
    { id: "UFEXSiIbN2U", title: "MTV Lineup — New Drop 13", gradient: "from-fuchsia-500/20 to-rose-500/20" },
    { id: "hPIfU-M2DiM", title: "MTV Lineup — New Drop 14", gradient: "from-emerald-500/20 to-teal-500/20" },
    { id: "cHnRg68x-T0", title: "MTV Lineup — New Drop 15", gradient: "from-cyan-500/20 to-emerald-500/20" },
    { id: "bQ4wl2QVKtQ", title: "MTV Lineup — New Drop 16", gradient: "from-amber-500/20 to-rose-500/20" },
    { id: "N7I-ARetgzs", title: "MTV Lineup — New Drop 17", gradient: "from-indigo-500/20 to-purple-500/20" },
    { id: "aUUn0bODxJ0", title: "MTV Lineup — New Drop 18", gradient: "from-sky-500/20 to-cyan-500/20" },
    { id: "Uvd8xBli20w", title: "MTV Lineup — New Drop 19", gradient: "from-rose-500/20 to-pink-500/20" },
    { id: "tZXaKaCPiUw", title: "MTV Lineup — New Drop 20", gradient: "from-violet-500/20 to-fuchsia-500/20" },
    { id: "W-j8E3WQch8", title: "MTV Lineup — New Drop 21", gradient: "from-emerald-500/20 to-cyan-500/20" },
    { id: "oGetKTwsTec", title: "MTV Lineup — New Drop 22", gradient: "from-purple-500/20 to-fuchsia-500/20" },
    { id: "4b29b5lJhIg", title: "MTV Lineup — New Drop 23", gradient: "from-orange-500/20 to-red-500/20" },
    { id: "GKjxLY7sIWQ", title: "MTV Lineup — New Drop 24", gradient: "from-amber-500/20 to-orange-500/20" },
    { id: "FmXXrKxnh9U", title: "MTV Lineup — New Drop 25", gradient: "from-cyan-500/20 to-teal-500/20" },
    { id: "91PvTue2Zr0", title: "MTV Lineup — New Drop 26", gradient: "from-indigo-500/20 to-purple-500/20" },
    { id: "J9A44q6pXOY", title: "MTV Lineup — New Drop 27", gradient: "from-emerald-500/20 to-lime-500/20" },
    { id: "xvcu_ALb3N0", title: "MTV Lineup — New Drop 28", gradient: "from-sky-500/20 to-cyan-500/20" },
    { id: "LThRs-T8big", title: "MTV Lineup — New Drop 29", gradient: "from-fuchsia-500/20 to-rose-500/20" },
    { id: "DkVtqUT581A", title: "MTV Lineup — New Drop 30", gradient: "from-emerald-500/20 to-teal-500/20" },
    { id: "OcFYWWYEoYk", title: "MTV Lineup — New Drop 31", gradient: "from-purple-500/20 to-indigo-500/20" },
    { id: "brKREzLfgjU", title: "MTV Lineup — New Drop 32", gradient: "from-amber-500/20 to-rose-500/20" },
    { id: "mQm6KsVGFSs", title: "MTV Lineup — New Drop 33", gradient: "from-violet-500/20 to-fuchsia-500/20" },
    {
      id: "VGZdXt3shq8",
