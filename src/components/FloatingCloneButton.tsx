...
const FloatingCloneButton = () => {
  ...
  return (
    <div
      className={`fixed left-2 top-28 z-50 transition-all duration-300 ${
        isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-full'
      }`}
    >
      <a
        href="https://lovable.dev/projects/2a39347d-b5b4-4ed5-985a-be0d4b766eb2?utm_source=lovable-badge/?via=aiwebtools"
        target="_blank"
        ...
        onClick={(e) => {
          ...
          createTimePortalEffect('https://lovable.dev/projects/2a39347d-b5b4-4ed5-985a-be0d4b766eb2?utm_source=lovable-badge/?via=aiwebtools', 'Clone AI Web Tools');
        }}
