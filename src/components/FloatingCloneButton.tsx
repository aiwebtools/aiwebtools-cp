...
const FloatingCloneButton = () => {
  ...
  return (
    ...
    >
      <a
        href="https://lovable.dev/projects/06ad257c-9fa7-4355-98c6-ec5ffc381ca8?via=aiwebtools"
        target="_blank"
        ...
        onClick={(e) => {
          ...
          createTimePortalEffect('https://lovable.dev/projects/06ad257c-9fa7-4355-98c6-ec5ffc381ca8?via=aiwebtools', 'Clone AI Web Tools');
        }}
