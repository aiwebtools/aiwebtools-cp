...
const FloatingCloneButton = () => {
  ...
  return (
    ...
    >
      <a
        href="https://lovable.dev/projects/62f3361a-cf19-4d84-aec6-e34d98aefe41?utm_source=lovable-badge/?via=aiwebtools"
        target="_blank"
        ...
        onClick={(e) => {
          ...
          createTimePortalEffect('https://lovable.dev/projects/62f3361a-cf19-4d84-aec6-e34d98aefe41?utm_source=lovable-badge/?via=aiwebtools', 'Clone AI Web Tools');
        }}
