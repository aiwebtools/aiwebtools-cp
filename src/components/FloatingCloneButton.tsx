...
const FloatingCloneButton = () => {
  ...
  return (
    ...
    >
      <a
        href="https://lovable.dev/projects/f5c061a4-be09-4cd2-9265-8ff4b0a05d3c?via=aiwebtools"
        target="_blank"
        ...
        onClick={(e) => {
          ...
          createTimePortalEffect('https://lovable.dev/projects/f5c061a4-be09-4cd2-9265-8ff4b0a05d3c?via=aiwebtools', 'Clone AI Web Tools');
        }}
