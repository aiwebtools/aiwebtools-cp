...
const FloatingCloneButton = () => {
  ...
  return (
    ...
    >
      <a
        href="https://lovable.dev/projects/eb113daf-a9c6-4f2f-b6e3-adb166f054a1?via=aiwebtools"
        target="_blank"
        ...
        onClick={(e) => {
          ...
          createTimePortalEffect('https://lovable.dev/projects/eb113daf-a9c6-4f2f-b6e3-adb166f054a1?via=aiwebtools', 'Clone AI Web Tools');
        }}
