...
const FILTER_CATEGORIES = {
  "EDUCATION & LEARNING": [
    "EDUCATION", "COLLEGE DEGREE", "COLLEGE PROFESSOR", "LEARN ANY", "HOME SCHOOL", "HOMESCHOOL", "COURSE", 
    ...
    "MUSIC LESSONS", "MUSIC MELODIES & LESSONS", "EDUCATOR PRO"
  ],
  "HEALTH & WELLNESS": [
  ...
  "INVESTIGATION & RESEARCH": [
    ...
    "REALITY SPLITTER", "WORLD RESOURCE", "DECLASSIFIED"
  ],
  "PROFESSIONAL & CIVIC": [
    ...
    "PLASTOLINE", "AUTOMOTIVE", "AUTOMOBILE", "CONSTRUCTION", "INFRASTRUCTURE",
    "NONPROFIT", "MICROGRID", "WATER SAFETY", "LEADERSHIP", "ENTREPRENEUR", "SIDE HUSTLE",
    "GREEN ENERGY", "COMPETITOR", "FINANCIAL MODEL"
  ],
  "CREATIVE & LIFESTYLE": [
