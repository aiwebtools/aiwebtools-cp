...
const FILTER_CATEGORIES = {
  ...
  "HEALTH & WELLNESS": [
    ...
    "THERAPY", "MENTAL", "CBT", "COUNSELING", "PSYCHIATRY", "PSYCHOLOGY", "CARL JUNG",
  ...
  "INVESTIGATION & RESEARCH": [
    ...
    "FACT CHECK", "VERIFICATION", "EVIDENCE",
  ...
  "PROFESSIONAL & CIVIC": [
    ...
    "CAREER", "RESUME", "JOB FINDER", "INSPECTOR", "APPRAISAL", "STARTUP", "SOCIAL SAFETY",
