...
const FILTER_CATEGORIES = {
  "EDUCATION & LEARNING": [
    ...
    "SKILL LEARNING", "TUTORING", "TUTOR", "ACADEMIC", "STUDY", "TRAINING MANUAL", "QUIZ", 
  ...
  "SPIRITUALITY & AWAKENING": [
    ...
    "BILL DONAHUE", "AETHER GUIDE", "REALITY DECODER"
  ],
  "HEALTH & WELLNESS": [
    ...
    "GENOME", "GENETICS", "DNA", "GENETIC", "GENOMICS",
  ...
  "INVESTIGATION & RESEARCH": [
    ...
    "REALITY SPLITTER", "WORLD RESOURCE"
  ],
  "PROFESSIONAL & CIVIC": [
  ...
  "CREATIVE & LIFESTYLE": [
    ...
    "TRAIL MAPPER", "OUTDOOR", "COOKING", "NEWS MEDIA", "MR. FIX IT"
  ]
};
